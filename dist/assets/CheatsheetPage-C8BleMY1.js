import{d as k,c as i,a as e,b as m,w as p,y as C,A as T,F as f,r as x,t as s,f as b,l as g,m as L,i as A,o as r,h,k as M}from"./index-DYW47o_w.js";import{_ as P}from"./site-logo-BehEtZ_y.js";const v=[{id:"basics",title:"Basics",icon:"📦",color:"mint",items:[{title:"Print",code:`print("Hello, World!")
...
cat = Cat("Whiskers")`},{title:"Dunder Methods",code:`class Vector:
    ...
    def __add__(self, other):
        return Vector(self.x+other.x, self.y+other.y)`}]}],S={class:"min-h-screen bg-grid"},B={class:"sticky top-0 z-50 border-b border-border bg-void/80 backdrop-blur-xl"},F={class:"mx-auto flex h-16 max-w-none items-center justify-between px-8"},N={class:"flex items-center gap-4"},D={class:"flex items-center gap-4"},V={class:"mx-auto max-w-none px-8 py-10"},O={class:"mb-10"},H={class:"relative max-w-xl"},I={class:"flex flex-wrap gap-3 mb-10"},W=["onClick"],q={class:"space-y-8"},j=["id"],E={class:"font-display text-lg font-bold mb-4 flex items-center gap-2"},z={class:"grid md:grid-cols-2 lg:grid-cols-3 gap-4"},R={class:"text-sm font-semibold text-text-primary mb-2 group-hover:text-mint transition-colors"},U={class:"relative"},$={class:"font-mono text-[11px] leading-relaxed text-text-secondary bg-surface/50 rounded-lg p-3 overflow-x-auto"},Q=["onClick"],Y={key:0,class:"mt-2 text-[10px] text-text-muted italic"},G={key:0,class:"text-center py-16"},J={class:"text-text-muted text-sm"},te=k({__name:"CheatsheetPage",setup(K){const d=g(""),c=g(""),u=L(()=>{if(!d.value.trim())return v;const o=d.value.toLowerCase();return v.map(t=>({...t,items:t.items.filter(l=>l.title.toLowerCase().includes(o)||l.code.toLowerCase().includes(o)||l.note&&l.note.toLowerCase().includes(o)||t.title.toLowerCase().includes(o))})).filter(t=>t.items.length>0)});function y(o){const t={mint:"bg-mint/10 border-mint/20 text-mint hover:bg-mint/20",amber:"bg-amber/10 border-amber/20 text-amber hover:bg-amber/20",coral:"bg-coral/10 border-coral/20 text-coral hover:bg-coral/20",sky:"bg-sky/10 border-sky/20 text-sky hover:bg-sky/20",lavender:"bg-lavender/10 border-lavender/20 text-lavender hover:bg-lavender/20"};return t[o]||t.mint}function _(o){document.getElementById(`cat-${o}`)?.scrollIntoView({behavior:"smooth"})}async function w(o){await navigator.clipboard.writeText(o),c.value=o,setTimeout(()=>{c.value=""},2e3)}return(o,t)=>{const l=A("router-link");return r(),i("div",S,[e("nav",B,[e("div",F,[e("div",N,[m(l,{to:"/",class:"flex items-center gap-3"},{default:p(()=>[...t[1]||(t[1]=[e("img",{src:P,alt:"Python Workshop logo",class:"h-10 w-10 object-contain"},null,-1),e("span",{class:"font-display text-base font-bold"},"Cheat Sheet",-1)])]),_:1})]),e("div",D,[m(l,{to:"/workshop",class:"text-sm text-text-secondary hover:text-text-primary transition-colors"},{default:p(()=>[...t[2]||(t[2]=[h("← Workshop",-1)])]),_:1}),m(l,{to:"/",class:"text-sm text-text-secondary hover:text-text-primary transition-colors"},{default:p(()=>[...t[3]||(t[3]=[h("Home",-1)])]),_:1})])])]),e("div",V,[e("div",O,[t[5]||(t[5]=e("h1",{class:"font-display text-4xl font-bold gradient-text mb-3"},"📝 Python Cheat Sheet",-1)),t[6]||(t[6]=e("p",{class:"text-lg text-text-secondary mb-6"},"Quick reference for everything you've learned. Click any category to jump there.",-1)),e("div",H,[C(e("input",{"onUpdate:modelValue":t[0]||(t[0]=n=>d.value=n),type:"text",placeholder:"Search cheatsheet...",class:"w-full rounded-xl bg-surface/50 border border-border/60 px-5 py-3 text-base text-text-primary placeholder-text-muted focus:border-mint/50 focus:outline-none focus:ring-1 focus:ring-mint/30 transition-all"},null,512),[[T,d.value]]),t[4]||(t[4]=e("span",{class:"absolute right-4 top-1/2 -translate-y-1/2 text-text-muted text-sm"},"🔍",-1))])]),e("div",I,[(r(!0),i(f,null,x(u.value,n=>(r(),i("button",{key:n.id,class:M(["rounded-lg px-4 py-2 text-sm font-medium border transition-all hover:scale-105",y(n.color)]),onClick:a=>_(n.id)},s(n.icon)+" "+s(n.title),11,W))),128))]),e("div",q,[(r(!0),i(f,null,x(u.value,n=>(r(),i("section",{key:n.id,id:`cat-${n.id}`,class:"scroll-mt-20"},[e("h2",E,[e("span",null,s(n.icon),1),e("span",null,s(n.title),1)]),e("div",z,[(r(!0),i(f,null,x(n.items,a=>(r(),i("div",{key:a.title,class:"glass rounded-xl p-4 hover:border-border transition-all group"},[e("h3",R,s(a.title),1),e("div",U,[e("pre",$,[e("code",null,s(a.code),1)]),e("button",{class:"absolute top-2 right-2 text-[10px] text-text-muted hover:text-mint opacity-0 group-hover:opacity-100 transition-all",onClick:X=>w(a.code)},s(c.value===a.code?"✓":"📋"),9,Q)]),a.note?(r(),i("p",Y,"💡 "+s(a.note),1)):b("",!0)]))),128))])],8,j))),128))]),u.value.length===0?(r(),i("div",G,[t[7]||(t[7]=e("p",{class:"text-3xl mb-3"},"🔍",-1)),e("p",J,'No results for "'+s(d.value)+'"',1)])):b("",!0)])])}}});export{te as default};
