import{d as j,q as W,c as p,a as e,b as m,w as f,g as v,y as E,z as S,u as x,t as _,h as b,k as O,l,i as R,o as g}from"./index-ChxLdxDR.js";import{u as T,E as H,o as V,l as A,p as F,k as N,d as B,i as D,a as M,b as z,c as q,e as y}from"./index-gYtEGKN9.js";const G={class:"min-h-screen bg-grid"},L={class:"sticky top-0 z-50 border-b border-border bg-void/80 backdrop-blur-xl"},I={class:"mx-auto flex h-16 max-w-none items-center justify-between px-8"},K={class:"flex items-center gap-4"},U={class:"flex items-center gap-4"},J={class:"mx-auto max-w-none px-8 py-10"},Q={class:"grid lg:grid-cols-2 gap-6"},X={class:"glass rounded-2xl overflow-hidden"},Y={class:"flex items-center justify-between px-6 py-4 border-b border-border/50"},Z={class:"flex gap-3"},$={class:"glass rounded-2xl overflow-hidden flex flex-col"},ee={class:"flex items-center justify-between px-6 py-4 border-b border-border/50"},te={class:"flex gap-3"},ne=["disabled"],oe={class:"flex-1 p-6 overflow-auto"},se={key:0,class:"flex items-center gap-3 text-sm text-text-muted animate-pulse"},re=`# 🐍 Python Playground
