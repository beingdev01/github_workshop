...
export const day1Welcome: ContentBlock[] = [
      ...
      questions: [
        {
          ...
          options: ['display()', 'print()', 'show()', 'console.log()'],
          correctIndex: 1,
          explanation: 'print() is the built-in function used to display output to the screen in Python.',
        },
        {
          type: 'predict-output',
          code: 'print("Hello")\nprint(2 + 3)',
          options: ['Hello 5', 'Hello\\n5', '"Hello"\\n5', 'Error'],
          correctIndex: 1,
          explanation: 'Each print() outputs on a new line. "Hello" appears first, then 5 (the result of 2+3) on the next line.',
        },
        {
          type: 'mcq',
          ...
          options: ['//', '#', '/*', '--'],
          correctIndex: 1,
          explanation: 'The # symbol starts a single-line comment in Python. Everything after # on that line is ignored.',
        },
        {
          type: 'predict-output',
          ...
          correctIndex: 1,
          explanation: 'The sep parameter changes the separator between values. Here it\'s set to "-" instead of the default space.',
        },
        {
          type: 'mcq',
          ...
          correctIndex: 2,
          explanation: 'A NameError occurs when you reference a variable name that Python hasn\'t seen before (not defined).',
        },
      ],
    },
  },
  {
    ...
    challenge: {
      ...
      difficulty: 'easy',
      description: 'Create a formatted "introduction card" that prints:\n1. A border line of 30 asterisks\n2. Your name with a greeting\n3. A fun fact about yourself\n4. Your favorite number and why\n5. Another border line of 30 asterisks',
      starterCode: '# Create your introduction card!\nprint("*" * 30)\nprint("Hello, I am ___!")\nprint("Fun fact: ___")\nprint("My favorite number is", ___)\nprint("*" * 30)',
      testCases: [
        { expected: '******************************', description: 'First line should be 30 asterisks' },
        { expected: '******************************', description: 'Last line should be 30 asterisks', hidden: true },
      ],
      hints: [
        'Replace ___ with your own text and numbers',
        'Use "string" * number to repeat a string',
        'You can pass multiple values to print() with commas',
      ],
